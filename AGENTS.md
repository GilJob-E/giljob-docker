...
Skip or avoid editing `__pycache__/`, `node_modules/`, `.tmp-gemini-default-marker`, build/cache artifacts, and vendor residue unless the task explicitly asks for cleanup. Do not treat generated SVG/assets as the editable architecture source.
