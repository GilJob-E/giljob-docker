...
- Transcribe candidate answer audio after the manual answer-end button submits raw browser audio.
...
- Return structured transcript JSON to the browser/Main LLM boundary.
