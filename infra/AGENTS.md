...
Caddy currently proxies `/ai/*` to `ai-engine` for the current question-generation slice, while ADR 0002 treats AI Engine and Agent1 as internal components. Document this `/ai/*` ingress tension clearly before expanding public AI routes.
